...
# 搜索范围：徐家汇核心地块 + 1km缓冲区
# 用polygon定义搜索范围（经度,纬度 格式，多边形顶点，首尾闭合）
# 以下是徐家汇街道大致范围的矩形边界（约3.5km × 3.5km）
# 你可以根据实际地块精确调整
SEARCH_POLYGON = (
    "121.4200,31.1780|"  # 西南角
    "121.4700,31.1780|"  # 东南角
    "121.4700,31.2130|"  # 东北角
    "121.4200,31.2130"   # 西北角
)
